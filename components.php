...
<?php }
	...
	<?php if($type=='school') {?>
				<ul class="nav navbar-nav">
					<li><a href="<?php echo $filepath;?>team.php">Team List</a></li>
					<li><a href="<?php echo $filepath;?>teams.php">Edit League</a></li>
					<li><a href="<?php echo $filepath;?>players.php">Statistics</a></li>
