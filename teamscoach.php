			...
			<div class="col-md-12">
				<table class="table table-striped table-hover table-responsive">
					<tbody>
							...
							<?php  $con=mysqli_connect("sql2.njit.edu","sbs43","hurrah37","sbs43");
						// Check connection
						if (mysqli_connect_errno())
						{
						echo "Failed to connect to MySQL: " . mysqli_connect_error();
						}
						$result = mysqli_query($con,"SELECT t.* FROM team AS t
   INNER JOIN coachaccount AS tr
   ON t.ID = tr.ID");
						...
						echo "<form action=updates.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            ...
            <option value=0>no</option>
						...
						echo "<form action=update1s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start1.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update2s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
            ...
            <option value=0>no</option>
						...
						echo "<form action=update3s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start3.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update4s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start4.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update5s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start5.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update6s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start6.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update7s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start7.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update8s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start8.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
						...
						echo "<form action=update9s.php method=get>";
						echo "<td>" . "<input type=text name=name> <input type=submit name=Submit value=update />" . "</td>";
						echo "</form>";
						echo "<td>"
						. "<form action=start9.php method=get>"
						 . "<select name=start>
            <option value='' disabled selected style='display:none;'>Is he a Starter?</option>
            <option value=1>yes</option>
            <option value=0>no</option>
